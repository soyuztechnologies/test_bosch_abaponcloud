...
@VDM.viewType: #BASIC
define view entity ZBSH_AB_BOOKING as select from /dmo/booking_m
composition[0..*] of ZBSH_AB_BOOKSUPPL as _BookingSupplement 
association to parent ZBSH_AB_TRAVEL as _Travel on
...
association of one to one /DMO/I_Connection as _Connections on
