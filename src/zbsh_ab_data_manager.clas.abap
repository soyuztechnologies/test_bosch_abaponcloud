CLASS zbsh_ab_data_manager DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZBSH_AB_DATA_MANAGER IMPLEMENTATION.
...
*        output =
   ...
   data : lt_bp type table of zbsh_ab_bpa1,
          lt_prod type table of zbsh_ab_product.
   append value #(
  ...
  append value #(
   ...
   append value #(
                   ...
                   to lt_prod.
    insert zbsh_ab_bpa1 from table @lt_bp.
    insert zbsh_ab_product from table @lt_prod.
 ENDMETHOD.
 ...
 METHOD fill_transaction_data.
   data : o_rand type REF TO cl_abap_random_int,
          ...
          lv_ord_id type zbsh_ab_dte_id,
          lt_so type table of zbsh_ab_so_hdr,
          lt_so_i type table of zbsh_ab_so_item.
   ...
   select * from zbsh_ab_bpa1 into table @data(lt_bpa).
   select * from zbsh_ab_product into table @data(lt_prod).
   do 50 times.
       ...
       enddo.
   enddo.
   insert zbsh_ab_so_hdr from table @lt_so.
   insert zbsh_ab_so_item from table @lt_so_i.
 ENDMETHOD.


 METHOD flush.
   delete from : zbsh_ab_bpa1, zbsh_ab_product, zbsh_ab_so_hdr, zbsh_ab_so_item.
 ENDMETHOD.
ENDCLASS.
