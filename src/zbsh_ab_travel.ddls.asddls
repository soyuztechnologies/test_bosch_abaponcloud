...
@VDM.viewType: #BASIC
define root view entity ZBSH_AB_TRAVEL as select from /dmo/travel_m
composition[0..*] of ZBSH_AB_BOOKING as _Booking
...
association of one to one /DMO/I_Travel_Status_VH as _Status on
    $projection.OverallStatus = _Status.TravelStatus            
{
